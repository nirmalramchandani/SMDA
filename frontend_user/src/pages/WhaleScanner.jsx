  ...
  if (loading) {
    return (
      <div className="loader-container">
        ...
        <p className="loader-text">Loading whale database...</p>
      </div>
    );
  }
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6 animate-in">
        <div>
          <h1 className="page-title">Whale Scanner</h1>
          <p className="page-subtitle">
            {filtered.length.toLocaleString()} entities — Filter, rank, and profile institutional investors
          </p>
        </div>
      </div>
