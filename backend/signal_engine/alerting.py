...
class NotificationService:
    ...
    async def send_alert(self, signal: SignalSchema) -> bool:
        ...
        subject = f"🐋 WhaleTrace Alert: {signal.symbol} ({signal.strength_score:.1f}/100)"
            ...
            <body style="font-family: Arial, sans-serif; background-color: #f9f9f9; padding: 20px; color: #333;">
                <div style="max-width: 600px; margin: 0 auto; background: white; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                    <div style="background-color: #0f172a; padding: 20px; text-align: center;">
                        <h1 style="color: white; margin: 0; font-size: 24px;">WhaleTrace Engine</h1>
                    </div>
        ...
        html_body += f"""
                    ...
                    <div style="background-color: #f1f5f9; text-align: center; padding: 15px; font-size: 12px; color: #64748b;">
                        Automated by WhaleTrace Signal Engine. Not financial advice.
                    </div>
                </div>
            </body>
        </html>
